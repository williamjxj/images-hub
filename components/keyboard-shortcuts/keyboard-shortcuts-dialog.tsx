...
export function KeyboardShortcutsDialog() {
  const { isHelpDialogOpen, closeHelpDialog, getAllShortcuts } = useKeyboardShortcutsContext();
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="mt-6 pt-4 border-t">
          <p className="text-xs text-muted-foreground">
            Tip: Press <kbd className="px-1.5 py-0.5 text-xs font-semibold bg-muted border border-border rounded">Esc</kbd> to close this dialog
          </p>
        </div>
      </DialogContent>
    </Dialog>
